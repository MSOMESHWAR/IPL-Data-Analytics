...
CREATE TABLE Player (
    ...
    DOB DATE,
    Batting_hand INT,
    Bowling_skill INT DEFAULT NULL,  -- Assuming Bowling_skill can be NULL
    Country_Name INT,
...
CREATE TABLE Match_ (
    ...
    Toss_Decide INT,
    Win_Type INT,
    Win_Margin DECIMAL(10, 2),
    Outcome_type INT,
    Match_Winner INT DEFAULT NULL,  -- Assuming Match_Winner can be NULL
    Man_of_the_Match INT DEFAULT NULL,  -- Assuming Man_of_the_Match can be NULL
...
LOAD DATA INFILE 'Venue.csv' INTO TABLE venue
